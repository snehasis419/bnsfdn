...
<?php
	...
	$targetpage = "short.php"; 	
	$limit = 25; 
	
	$query = "SELECT COUNT(*) as num FROM $tableName WHERE status='S'";
    ...
    // Get page data
	$query1 = "SELECT * FROM $tableName WHERE status='S' ORDER BY income LIMIT $start, $limit";
...
echo '<h3>Shortlisted Candidates:-</h3>';
echo '<br>';
