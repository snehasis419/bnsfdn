...
<?php
	...
	$query = "SELECT COUNT(*) as num FROM $tableName WHERE status='R'";
    ...
    // Get page data
	$query1 = "SELECT * FROM $tableName WHERE status='R' ORDER BY income LIMIT $start, $limit";
...
echo '<h3>Rejected Candidates:-</h3>';
echo '<br>';
