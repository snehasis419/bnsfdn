 ...
 if(isset($_POST[$ems]))
 {
	...
	if($sta=="W")
	{
      $message = 'Dear '.$nama.',<br><br>
                 Thank you for considering our foundation. We appreciate your effort in applying for the scholarship.<b>However, we have currently kept your application on hold (waitlisted). We will keep you updated of the status change if any.</b><br>
                 <b>Reason for Waitlist</b>: One of the following could be the reason for rejection:<br>
                 1.Percentage margin is low<br>
                 2.Better profile of other candidates<br>
                 3.Income more than other candidates<br>
